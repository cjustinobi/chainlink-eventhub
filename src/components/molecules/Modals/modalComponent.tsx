  ...
  return (
    ...
    >
      <div className="p-5 rounded-lg bg-[#fff] lg:w-[40vw] overflow-x-auto no-scrollbar relative flex justify-center items-center flex-col">
        <button
          className="absolute right-5 top-5 text-customGray hover:text-customGold"
          onClick={onClose}
        >
          <svg
        ...
        <button
          onClick={onClose}
          className="flex justify-center items-center bg-customGold text-white text-base font-medium py-3 px-4 rounded-lg hover:bg-opacity-80 w-full"
        >
          Done
        </button>
      </div>
